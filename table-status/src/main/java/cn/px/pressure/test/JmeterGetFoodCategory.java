 ...
 */
public class JmeterGetFoodCategory extends AbstractJavaSamplerClient implements Serializable, Interruptible {

    private String urlPaht = "/irs-iface/om/inf/food/v1/getFoodCategory";
