 ...
 */
public class JmeterGetFoodUnit extends AbstractJavaSamplerClient implements Serializable, Interruptible {

    private String urlPaht = "/irs-iface/om/inf/food/v1/getFoodunit";
